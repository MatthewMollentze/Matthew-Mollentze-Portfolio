...
// UNUSED EXPORTS: Animation, Section
...
let SocialProfile;(function(SocialProfile){SocialProfile["Behance"]="behance";SocialProfile["GitHub"]="github";SocialProfile["Medium"]="medium";SocialProfile["Mail"]="mail";SocialProfile["LinkedIn"]="linkedin";SocialProfile["Twitter"]="twitter";SocialProfile["Hashnode"]="hashnode";})(SocialProfile||(SocialProfile={}));function SocialProfiles(props){const siteMetadata=(0,useSiteMetadata/* useSiteMetadata */.$)();// Enrich the social profile with data from the display name configuration file
// as well as the site metadata from settings.json
const shownProfiles=props.from.map(profile=>{const normalizedProfileId=profile.toLowerCase();if(Object.values(SocialProfile).includes(normalizedProfileId)){return{id:normalizedProfileId,label:socialProfileLabels[normalizedProfileId],url:siteMetadata.social[normalizedProfileId]};}else{throw new Error(`Unknown social profile ${profile}.`);}});return/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(Slider/* Slider */.i,null,shownProfiles.map((profile,key)=>{const completeProfileData=profile.label&&profile.url;return!completeProfileData?null:/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement("a",{key:key,className:Profile,href:profile.url,target:"_blank",rel:"nofollow noopener noreferrer","aria-label":profile.label,style:props.showIcon?{padding:'0.5rem 1.25rem'}:undefined},props.showIcon?/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(Icon,{name:profile.id}):undefined," ",profile.label);}));}
;// CONCATENATED MODULE: ./node_modules/gatsby-theme-portfolio-minimal/src/sections/Hero/data.tsx
const useLocalDataSource=()=>{return (0,gatsby_browser_entry.useStaticQuery)("3525841079");};
...
function HeroSection(props){var _data$heroPhoto,_data$image;const response=useLocalDataSource();const data=response.allHeroJson.sections[0];const CalendlyWidget=useCalendlyWidget(data.calendly);return/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(Animation/* Animation */.f,{type:"fadeUp",delay:400},CalendlyWidget,/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(Section/* Section */.$,{anchor:props.sectionId,additionalClasses:[HeroContainer]},((_data$heroPhoto=data.heroPhoto)===null||_data$heroPhoto===void 0?void 0:_data$heroPhoto.src)&&/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement("div",{className:heroImageCont},/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(gatsby_image_module/* GatsbyImage */.HN,{className:heroImage,image:data.heroPhoto.src.childImageSharp.gatsbyImageData,alt:data.heroPhoto.alt||`Profile Image`,loading:"eager"})),/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement("div",{className:Hero},/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement("div",{className:Intro},data.intro&&/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement("span",{className:ImagePrefix},data.intro),((_data$image=data.image)===null||_data$image===void 0?void 0:_data$image.src)&&/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(Animation/* Animation */.f,{className:Image,type:"waving-hand",duration:2500,iterationCount:3},/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(gatsby_image_module/* GatsbyImage */.HN,{image:data.image.src.childImageSharp.gatsbyImageData,alt:data.image.alt||`Intro Image`,loading:"eager"}))),/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement("h1",{className:Title},data.title),/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement("h2",{className:Subtitle},data.subtitle.prefix,/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement("u",null,data.subtitle.highlight),data.subtitle.suffix),/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement("p",null,data.description),/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(Animation/* Animation */.f,{type:"fadeLeft",delay:600},data.socialProfiles&&/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(SocialProfiles,{from:data.socialProfiles.from,showIcon:data.socialProfiles.showIcons})))));}
...
return RSS_2_JSON_API+encodeURIComponent(profileUrl.replace(/\/+$/,'')+'/feed');}const data_useLocalDataSource=()=>{return (0,gatsby_browser_entry.useStaticQuery)("540466502");};
...
var ArticleSource;(function(ArticleSource){ArticleSource["Medium"]="medium";ArticleSource["Blog"]="blog";})(ArticleSource||(ArticleSource={}));function ArticlesSection(props){const response=data_useLocalDataSource();const[articles,setArticles]=external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().useState([]);const configuration=validateAndConfigureSources(props.sources);async function collectArticlesFromSources(configuration){const mediumConfig=configuration[ArticleSource.Medium];const blogConfig=configuration[ArticleSource.Blog];const articleList=[];if(mediumConfig!==undefined){const mediumArticles=await useMediumFeed(mediumConfig.profileUrl);if(mediumArticles.length>0){mediumArticles.forEach(article=>{articleList.push({category:article.categories[0],title:article.title,publishedAt:new Date(article.pubDate.replace(/-/g,'/')),// https://stackoverflow.com/a/5646753
link:article.link});});}}if(blogConfig!==undefined){const blogArticles=response.allArticle.articles;if(blogArticles.length>0){blogArticles.forEach(article=>{articleList.push({category:article.categories[0],title:article.title,publishedAt:new Date(article.date.replace(/-/g,'/')),link:article.slug,readingTime:article.readingTime.text});});}}return articleList.slice().sort((a,b)=>b.publishedAt.getTime()-a.publishedAt.getTime());}external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().useEffect(()=>{(async function(){setArticles(await collectArticlesFromSources(configuration));})();},[]);return/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(Animation/* Animation */.f,{type:"fadeUp",delay:1000},/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(Section/* Section */.$,{anchor:props.sectionId,heading:props.heading},/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(Slider/* Slider */.i,{additionalClasses:[Articles]},articles.length>0?articles.slice(0,3).map((article,key)=>{return/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(ArticleCard/* ArticleCard */.T,{key:key,data:article});}):[...Array(3)].map((_,key)=>{return/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(ArticleCard/* ArticleCardSkeleton */.w,{key:key});}))));}// validateAndConfigureSources: Sources for articles can be defined as props (e.g. sources=["Medium"])
...
function AboutSection(props){const response=About_data_useLocalDataSource();const data=response.allAboutMarkdown.sections[0];return/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(Animation/* Animation */.f,{type:"fadeUp"},/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(Section/* Section */.$,{anchor:props.sectionId,heading:props.heading},/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement("div",{className:About},/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement("div",{className:Description,dangerouslySetInnerHTML:{__html:data.html}}),/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(Animation/* Animation */.f,{type:"fadeLeft",delay:200},/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement("div",{className:ImageWrapper},/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(gatsby_image_module/* GatsbyImage */.HN,{image:data.frontmatter.imageSrc.childImageSharp.gatsbyImageData,className:style_module_Image,alt:data.frontmatter.imageAlt||`About Image`}))))));}
...
const Interests_data_useLocalDataSource=()=>{return (0,gatsby_browser_entry.useStaticQuery)("2442753764");};
...
function InterestsSection(props){var _data$button$initiall;const response=Interests_data_useLocalDataSource();const data=response.allInterestsJson.sections[0];const shouldShowButton=data.button.visible!==false;const initiallyShownInterests=(_data$button$initiall=data.button.initiallyShownInterests)!==null&&_data$button$initiall!==void 0?_data$button$initiall:5;const[shownInterests,setShownInterests]=external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().useState(shouldShowButton?initiallyShownInterests:data.interests.length);function loadMoreHandler(){setShownInterests(data.interests.length);}return/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(Animation/* Animation */.f,{type:"fadeUp"},/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(Section/* Section */.$,{anchor:props.sectionId,heading:props.heading},/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement("div",{className:Interests},data.interests.slice(0,shownInterests).map((interest,key)=>{return/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(Animation/* Animation */.f,{key:key,className:Interest,type:"scaleIn",delay:key*100},interest.image.src&&/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(gatsby_image_module/* GatsbyImage */.HN,{image:interest.image.src.childImageSharp.gatsbyImageData,className:style_module_Icon,alt:interest.image.alt||`Interest ${interest.label}`}),' ',interest.label);}),shouldShowButton&&shownInterests<data.interests.length&&/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(Animation/* Animation */.f,{type:"scaleIn",delay:(shownInterests+1)*100},/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(Button/* Button */.z,{type:Button/* ButtonType.BUTTON */.L.BUTTON,onClickHandler:loadMoreHandler,label:data.button.label})))));}
...
var LinkType;(function(LinkType){LinkType["External"]="external";LinkType["Github"]="github";})(LinkType||(LinkType={}));function Project_Project(props){const isDesktopBreakpoint=(0,useMediaQuery/* useMediaQuery */.a)('(min-width: 992px)');return/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(Animation/* Animation */.f,{type:"fadeUp",className:Project,style:{flexDirection:isDesktopBreakpoint&&props.index%2===0?'row-reverse':undefined}},/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement("div",{className:Details},/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement("span",{className:Category},props.data.category),/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement("h4",{className:style_module_Title},props.data.title),/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement("p",null,props.data.description),/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement("div",{className:Tags},props.data.tags&&props.data.tags.length!==0&&props.data.tags.map((tag,key)=>{return/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement("span",{key:key},/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement("u",null,tag));})),/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement("div",{className:Links},props.data.links&&props.data.links.length!==0&&props.data.links.map((link,key)=>{return/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement("a",{key:key,href:link.url,target:"_blank",rel:"nofollow noopener noreferrer","aria-label":"External Link"},/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(Icon,{name:link.type,color:"var(--subtext-color)"}));}))),props.data.image.src&&props.data.image.linkTo&&/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement("a",{href:props.data.image.linkTo,target:"_blank",rel:"noopener noreferrer","aria-label":"External Link"},/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(gatsby_image_module/* GatsbyImage */.HN,{className:ProjectImageWrapper,imgClassName:ProjectImage,image:props.data.image.src.childImageSharp.gatsbyImageData,alt:props.data.image.alt||`Project ${props.data.title}`})),props.data.image.src&&!props.data.image.linkTo&&/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(gatsby_image_module/* GatsbyImage */.HN,{className:ProjectImageWrapper,imgClassName:ProjectImage,image:props.data.image.src.childImageSharp.gatsbyImageData,alt:props.data.image.alt||`Project ${props.data.title}`}));}
...
function ProjectsSection(props){const response=Projects_data_useLocalDataSource();const data=response.allProjectsJson.sections[0];return/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(Animation/* Animation */.f,{type:"fadeIn"},/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(Section/* Section */.$,{anchor:props.sectionId,heading:props.heading},/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(Slider/* Slider */.i,{additionalClasses:[Projects]},data.projects.map((project,key)=>{return project.visible?/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(Project_Project,{key:key,index:key,data:project}):null;})),data.button!==undefined&&data.button.visible!==false&&/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(Animation/* Animation */.f,{className:MoreProjects,type:"fadeIn"},/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(Button/* Button */.z,{type:Button/* ButtonType.LINK */.L.LINK,externalLink:true,url:data.button.url,label:data.button.label}))));}
...
function ContactSection(props){const response=Contact_data_useLocalDataSource();const data=response.allContactJson.sections[0];return/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(Animation/* Animation */.f,{type:"fadeUp"},/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(Section/* Section */.$,{anchor:props.sectionId,heading:props.heading,additionalClasses:[Contact]},data.description&&/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement("p",{className:style_module_Description},data.description),/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement("div",{className:style_module_Profile},data.image.src&&/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(gatsby_image_module/* GatsbyImage */.HN,{className:Avatar,image:data.image.src.childImageSharp.gatsbyImageData,alt:data.image.alt||`Profile ${data.name}`}),/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement("div",{className:ContactDetails},/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement("div",{className:Name},data.name),/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement("u",null,/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement("a",{href:`mailto:${data.email}`},data.email)))),data.socialProfiles&&/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(SocialProfiles,{from:data.socialProfiles.from,showIcon:data.socialProfiles.showIcons})));}
...
function LegalSection(props){const response=Legal_data_useLocalDataSource();const data=getSectionBySectionId(response,props.sectionId);return/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(Section/* Section */.$,{anchor:props.sectionId,heading:props.heading},/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement("div",{dangerouslySetInnerHTML:{__html:data.html}}));}
...
function SkeletonLoader(_a) {
    ...
    return (external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(Tag, { className: css.skeleton, style: __assign({ width: width, height: height, background: background, borderRadius: circle ? "50%" : radius, display: block ? "block" : "inline-block" }, style) }, "\u200C"));
}
...
const absoluteUrl=props.data.link.indexOf('://')>0||props.data.link.indexOf('//')===0;const articleCard=/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement("article",{className:Card,style:darkModeEnabled?{border:'0.125rem solid var(--primary-color)'}:undefined},props.showBanner&&/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement("div",{className:Banner},props.data.image&&props.data.image.src&&/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(gatsby_image_module/* GatsbyImage */.HN,{className:ImageWrapper,imgClassName:Image,image:props.data.image.src.childImageSharp.gatsbyImageData,alt:props.data.image.alt||props.data.title})),/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement("div",{className:DescriptionWrapper},/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement("span",{className:Category},/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement("u",null,props.data.category)),/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement("h4",{className:Title},props.data.title),/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement("div",{className:Details},formatDate(props.data.publishedAt),props.data.readingTime&&/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement("span",{className:ReadingTime},props.data.readingTime))));return absoluteUrl?/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement("a",{href:props.data.link,target:"_blank",rel:"nofollow noopener noreferrer",title:props.data.title},articleCard):/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(gatsby_browser_entry.Link,{to:props.data.link,title:props.data.title},articleCard);}function ArticleCardSkeleton(){const{globalState}=(0,context/* useGlobalState */.j1)();const darkModeEnabled=globalState.theme===context/* Theme.Dark */.Q2.Dark;return/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement("div",{className:Card,style:darkModeEnabled?{border:'0.125rem solid var(--primary-color)'}:undefined},/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement("div",{className:DescriptionWrapper},/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(SkeletonLoader,{style:{height:'1.5rem',marginBottom:'.5rem',background:'var(--tertiary-color)'}}),/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(SkeletonLoader,{style:{height:'4rem',background:'var(--tertiary-color)'}}),/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(SkeletonLoader,{style:{height:'.75rem',width:'50%',marginTop:'.5rem',background:'var(--tertiary-color)'}})));}function formatDate(date){const months=['Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec'];return`${months[date.getMonth()]} ${date.getDate()}, ${date.getFullYear()}`;}
...
let ButtonType;(function(ButtonType){ButtonType["BUTTON"]="button";ButtonType["SUBMIT"]="submit";ButtonType["LINK"]="link";})(ButtonType||(ButtonType={}));function Button_Button(props){if(props.type===ButtonType.LINK){if(!props.url){throw new Error(`Button should be a ${props.type} but no URL is given!`);}else{if(props.externalLink){return/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement("a",{id:props.id,className:Button,href:props.url,target:"_blank",rel:"nofollow noopener noreferrer","aria-label":"External Link"},props.label);}else{return/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement(gatsby_browser_entry.Link,{id:props.id,to:props.url,className:Button},props.label);}}}else if(props.type===ButtonType.BUTTON||props.type===ButtonType.SUBMIT){if(!props.onClickHandler){throw new Error(`Button should be a ${props.type} but no onClickHandler is given!`);}return/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement("button",{id:props.id,className:Button,type:props.type,onClick:props.onClickHandler},props.label);}else{throw new Error(`Unknown button type specified.`);}}
...
function Slider(props){let classList;if(props.additionalClasses){classList=props.additionalClasses.concat(SlideContainer).join(' ');}else{classList=SlideContainer;}return/*#__PURE__*/external_C_Users_matth_REPOS_mjm_portfolio_portfolio_react_gatsby_node_modules_react_index_js_default().createElement("div",{className:classList,style:props.style},props.children);}
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6340);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var gatsby_theme_portfolio_minimal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(550);
function IndexPage(){return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment),null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby_theme_portfolio_minimal__WEBPACK_IMPORTED_MODULE_1__/* .Seo */ .pQ,{title:"Matthew Mollentze - Portfolio"}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby_theme_portfolio_minimal__WEBPACK_IMPORTED_MODULE_1__/* .Page */ .T3,{useSplashScreenAnimation:true},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby_theme_portfolio_minimal__WEBPACK_IMPORTED_MODULE_1__/* .HeroSection */ .DH,{sectionId:"hero"}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby_theme_portfolio_minimal__WEBPACK_IMPORTED_MODULE_1__/* .ArticlesSection */ .q6,{sectionId:"articles",heading:"Latest Articles",sources:['Medium']}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby_theme_portfolio_minimal__WEBPACK_IMPORTED_MODULE_1__/* .AboutSection */ .ez,{sectionId:"about",heading:"About Portfolio Minimal"}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby_theme_portfolio_minimal__WEBPACK_IMPORTED_MODULE_1__/* .InterestsSection */ .aS,{sectionId:"details",heading:"Details"}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby_theme_portfolio_minimal__WEBPACK_IMPORTED_MODULE_1__/* .ProjectsSection */ .Au,{sectionId:"features",heading:"Built-in Features"}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby_theme_portfolio_minimal__WEBPACK_IMPORTED_MODULE_1__/* .ContactSection */ .U0,{sectionId:"github",heading:"Issues?"})));}
